...
var __vue_module_identifier__$e = "data-v-7627c0c5";
/* functional template */
...
var __vue_scope_id__$d = "data-v-56731f35";
/* module identifier */

var __vue_module_identifier__$d = "data-v-56731f35";
/* functional template */
...
var script$c = {
  ...
  methods: {
    ...
    advanceOne: function advanceOne() {
...
var __vue_render__$c = function __vue_render__() {
  ...
  }, [_vm._ssrNode((_vm.step > 1 ? "<button" + _vm._ssrAttr("title", _vm.backTitle) + _vm._ssrAttr("disabled", _vm.step <= 1 || _vm.backDisabled) + _vm._ssrClass("btn-step", [{
    '--disabled': _vm.backDisabled
  }, _vm.handleTypesBtn]) + " data-v-18c4d902>" + _vm._ssrEscape("\n        " + _vm._s(_vm.textBtnBack) + "\n    ") + "</button>" : "<!---->") + " <button" + _vm._ssrAttr("title", _vm.advancedTitle) + _vm._ssrAttr("disabled", _vm.advancedDisabled) + _vm._ssrClass("btn-step", [{
...
var __vue_scope_id__$c = "data-v-18c4d902";
/* module identifier */

var __vue_module_identifier__$c = "data-v-18c4d902";
/* functional template */
...
var __vue_scope_id__$b = "data-v-b677bf08";
/* module identifier */

var __vue_module_identifier__$b = "data-v-b677bf08";
/* functional template */
...
var script$a = {
  ...
  methods: {
    ...
    //     }
    // },
    watchOptionsRedirect: function watchOptionsRedirect() {
      if (this.openOptionsRedirect == true) {
        this.openOptionsRedirectMethod();
    ...
    pathOrAncora: function pathOrAncora(linkRedirect) {
      // Is path:
    ...
    openOptionsRedirectMethod: function openOptionsRedirectMethod() {
      this.headerButtonMenu.classList.add("is-open-active");
      this.nav.classList.add("is-active");
    },
    closeOptionsRedirectMethod: function closeOptionsRedirectMethod() {
...
var __vue_scope_id__$a = "data-v-3f7e656b";
/* module identifier */

var __vue_module_identifier__$a = "data-v-3f7e656b";
/* functional template */
...
var __vue_module_identifier__$9 = "data-v-dfbfc100";
/* functional template */
...
var script$8 = {
  ...
  computed: {
    ...
    checkMaximumSize: function checkMaximumSize() {
  ...
  methods: {
    ...
    sendValue: function sendValue($e) {
      if (this.filterCpf === true && !this.filterPhone && !this.filterCep && !this.filterUf) {
        var vetMask = '###.###.###-##'.split("");
        var numCpf = $e.target.value.replace(/\D/g, "");
        var cursor = $e.target.selectionStart;
        var tecla = window.event ? event.keyCode : event.which;

        for (var i = 0; i < numCpf.length; i++) {
        ...
        var _numCpf = $e.target.value.replace(/\D/g, "");

        var _cursor = $e.target.selectionStart;

        var _tecla = window.event ? event.keyCode : event.which;

        for (var _i = 0; _i < _numCpf.length; _i++) {
          _vetMask.splice(_vetMask.indexOf("#"), 1, _numCpf[_i]);
        }

        $e.target.value = _vetMask.join("");

        if (_tecla != 37 && _cursor == 3 || _cursor == 7 || _cursor == 11) {
          $e.target.setSelectionRange(_cursor + 1, _cursor + 1);
        } else {
          $e.target.setSelectionRange(_cursor, _cursor);
        }
      } else if (this.filterRg === true && !this.filterCpf && !this.filterPhone && !this.filterCep && !this.filterUf) {
        var _vetMask2 = '##.###.###-#'.split("");

        var _numCpf2 = $e.target.value.replace(/\D/g, "");

        var _cursor2 = $e.target.selectionStart;

        var _tecla2 = window.event ? event.keyCode : event.which;

        for (var _i2 = 0; _i2 < _numCpf2.length; _i2++) {
          _vetMask2.splice(_vetMask2.indexOf("#"), 1, _numCpf2[_i2]);
        }

        $e.target.value = _vetMask2.join("");

        if (_tecla2 != 37 && _cursor2 == 3 || _cursor2 == 7 || _cursor2 == 11) {
          $e.target.setSelectionRange(_cursor2 + 1, _cursor2 + 1);
        } else {
          $e.target.setSelectionRange(_cursor2, _cursor2);
        }
    ...
    // FUNCTIONS OF SELECT:
    selectedElementSelect: function selectedElementSelect(value, event) {
      this.closeOptionsSelect(event.target.parentElement);
      this.openSelect = false;
      this.filterMethod(value);
      this.$emit('selectedValue', value);
    },
    selectOpenOrClose: function selectOpenOrClose($event) {
    ...
    openOptionsSelect: function openOptionsSelect(element) {
      element.classList.add("is-active");
    },
    closeOptionsSelect: function closeOptionsSelect(element) {
      if (element.classList != null) element.classList.remove("is-active");
    },
    // FUNCTIONS OF RADIO:
    selectedElementRadio: function selectedElementRadio(value) {
      this.$emit('selectedValue', value);
    }
  }
};/* script */
...
var __vue_render__$8 = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<label class=\"label\" data-v-2757be82>" + _vm._ssrEscape(_vm._s(_vm.label) + ":") + "</label> " + (_vm.type !== 'select' && _vm.type !== 'radio' ? "<div id=\"input-field\"" + _vm._ssrClass(null, {
    '--max-width-normal': _vm.fieldMaxWidthNormal
  }) + " data-v-2757be82><input" + _vm._ssrAttr("type", _vm.typeInputMoment) + _vm._ssrAttr("placeholder", _vm.placeholder ? _vm.placeholder : '') + _vm._ssrAttr("disabled", _vm.inputDisabled) + _vm._ssrAttr("maxlength", _vm.checkMaximumSize) + _vm._ssrAttr("value", _vm.value) + _vm._ssrClass("input", {
    '--disabled': _vm.inputDisabled,
    '--password-type': _vm.type === 'password'
  }) + " data-v-2757be82> " + (_vm.type === 'password' ? "<svg width=\"24\" height=\"14\" viewBox=\"0 0 24 14\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"" + _vm._ssrClass("icon-field", {
    '--disabled': _vm.inputDisabled
  }) + " data-v-2757be82><path d=\"M12 3C9.79403 3 8 4.79403 8 7.00005C8 9.20607 9.79403 11.0001 12 11.0001C14.2061 11.0001 16.0001 9.20607 16.0001 7.00005C16.0001 4.79403 14.2061 3 12 3ZM12 10.0001C10.346 10.0001 9 8.65411 9 7.0001C9 5.34609 10.346 4.00005 12 4.00005C13.6541 4.00005 15.0001 5.34609 15.0001 7.0001C15.0001 8.65411 13.6541 10.0001 12 10.0001Z\" fill=\"black\" data-v-2757be82></path> <path d=\"M23.9111 6.71612C23.7221 6.4411 19.18 0 11.9999 0C5.83883 0 0.348744 6.40411 0.11774 6.67712C-0.0392467 6.86312 -0.0392467 7.13613 0.11774 7.32311C0.348744 7.59612 5.83883 14.0002 11.9999 14.0002C18.1611 14.0002 23.6511 7.59612 23.8821 7.32311C24.0271 7.15113 24.0401 6.90212 23.9111 6.71612ZM11.9999 13.0002C7.06088 13.0002 2.36478 8.29016 1.17179 7.00014C2.36281 5.70914 7.05389 1.00005 11.9999 1.00005C17.779 1.00005 21.8581 5.70314 22.8541 6.97314C21.7041 8.22214 16.981 13.0002 11.9999 13.0002Z\" fill=\"black\" data-v-2757be82></path></svg>" : "<!---->") + " " + (_vm.typeInputMoment === 'text' && _vm.filterCep === true && _vm.verification === true ? "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"18px\" viewBox=\"0 0 24 24\" width=\"18px\" fill=\"#000000\"" + _vm._ssrClass("icon-field", {
    '--search': _vm.filterCep,
    '--disabled': _vm.disabled
  }) + " data-v-2757be82><path d=\"M0 0h24v24H0V0z\" fill=\"none\" data-v-2757be82></path> <path d=\"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z\" data-v-2757be82></path></svg>" : "<!---->") + "</div>" : "<!---->") + " " + (_vm.type === 'select' ? "<div id=\"dropdown\"" + _vm._ssrClass(null, {
    '--select-max-width-normal': _vm.fieldMaxWidthNormal
  }) + " data-v-2757be82><div id=\"dropdown-select\" data-v-2757be82><span id=\"select-label\" class=\"select\" data-v-2757be82>" + _vm._ssrEscape(_vm._s(_vm.item.value && _vm.item.label ? _vm.item.label : 'Selecione')) + "</span> <svg id=\"svg-icon\" width=\"17\" height=\"8\" viewBox=\"0 0 17 8\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" data-v-2757be82><path d=\"M1.58839 4.51715e-07L0.621093 0.870535L8.51744 8L16.4138 0.870535L15.4465 9.17941e-08L8.51744 6.28571L1.58839 4.51715e-07Z\" fill=\"#FBBE2F\" data-v-2757be82></path></svg></div> <div id=\"dropdown-list__element_select\" data-v-2757be82>" + _vm._ssrList(_vm.items, function (itemMoment, index) {
    return "<div" + _vm._ssrClass("dropdown-list__item", {
      '--selected': itemMoment == _vm.item,
      '--first': index == 0,
      '--last': index == _vm.items.length - 1
    }) + " data-v-2757be82>" + _vm._ssrEscape(_vm._s(itemMoment.label)) + "</div>";
  }) + "</div></div>" : "<!---->") + " " + (_vm.type === 'radio' ? "<div class=\"container-radio\" data-v-2757be82>" + _vm._ssrList(_vm.options, function (item, index) {
    return "<div class=\"radio\" data-v-2757be82><input id=\"id-radio\" name=\"radio\" type=\"radio\"" + _vm._ssrAttr("disabled", _vm.option.disabled) + _vm._ssrAttr("checked", _vm.option.value == item.value) + _vm._ssrAttr("value", _vm.option) + " data-v-2757be82> <label for=\"radio-1\" class=\"radio-label\" data-v-2757be82>" + _vm._ssrEscape(_vm._s(item.label)) + "</label></div>";
  }) + "</div>" : "<!---->") + " <span" + _vm._ssrClass("span-msg", {
    '--error': _vm.containsError
  }) + " data-v-2757be82>" + _vm._ssrEscape(_vm._s(_vm.msgFieldComputed)) + "</span>")]);
};
...
var __vue_scope_id__$8 = "data-v-2757be82";
/* module identifier */

var __vue_module_identifier__$8 = "data-v-2757be82";
/* functional template */
...
var __vue_render__$7 = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<input" + _vm._ssrAttr("type", _vm.type) + _vm._ssrAttr("placeholder", _vm.placeholder ? _vm.placeholder : '') + _vm._ssrAttr("disabled", _vm.disabled) + _vm._ssrAttr("maxlength", _vm.checkMaximumSize) + _vm._ssrAttr("value", _vm.value) + _vm._ssrClass("input", {
    '--disabled': _vm.disabled,
    '--password-type': _vm.typeField === 'password'
  }) + " data-v-575b32b7> " + (_vm.typeField === 'password' ? "<svg width=\"24\" height=\"14\" viewBox=\"0 0 24 14\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"" + _vm._ssrClass("icon-field", {
    '--disabled': _vm.disabled
  }) + " data-v-575b32b7><path d=\"M12 3C9.79403 3 8 4.79403 8 7.00005C8 9.20607 9.79403 11.0001 12 11.0001C14.2061 11.0001 16.0001 9.20607 16.0001 7.00005C16.0001 4.79403 14.2061 3 12 3ZM12 10.0001C10.346 10.0001 9 8.65411 9 7.0001C9 5.34609 10.346 4.00005 12 4.00005C13.6541 4.00005 15.0001 5.34609 15.0001 7.0001C15.0001 8.65411 13.6541 10.0001 12 10.0001Z\" fill=\"black\" data-v-575b32b7></path> <path d=\"M23.9111 6.71612C23.7221 6.4411 19.18 0 11.9999 0C5.83883 0 0.348744 6.40411 0.11774 6.67712C-0.0392467 6.86312 -0.0392467 7.13613 0.11774 7.32311C0.348744 7.59612 5.83883 14.0002 11.9999 14.0002C18.1611 14.0002 23.6511 7.59612 23.8821 7.32311C24.0271 7.15113 24.0401 6.90212 23.9111 6.71612ZM11.9999 13.0002C7.06088 13.0002 2.36478 8.29016 1.17179 7.00014C2.36281 5.70914 7.05389 1.00005 11.9999 1.00005C17.779 1.00005 21.8581 5.70314 22.8541 6.97314C21.7041 8.22214 16.981 13.0002 11.9999 13.0002Z\" fill=\"black\" data-v-575b32b7></path></svg>" : "<!---->") + " " + (_vm.typeField === 'text' && _vm.filterCep === true && _vm.verification === true ? "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"18px\" viewBox=\"0 0 24 24\" width=\"18px\" fill=\"#000000\"" + _vm._ssrClass("icon-field", {
    '--search': _vm.filterCep,
    '--disabled': _vm.disabled
  }) + " data-v-575b32b7><path d=\"M0 0h24v24H0V0z\" fill=\"none\" data-v-575b32b7></path> <path d=\"M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z\" data-v-575b32b7></path></svg>" : "<!---->"))]);
};
...
var __vue_scope_id__$7 = "data-v-575b32b7";
/* module identifier */

var __vue_module_identifier__$7 = "data-v-575b32b7";
/* functional template */
...
var __vue_module_identifier__$6 = "data-v-4afb901c";
/* functional template */
...
var __vue_module_identifier__$5 = "data-v-7c8783d2";
/* functional template */
...
var script$4 = {
  ...
  watch: {
    currentActive: function currentActive(newV, oldV) {
  ...
  methods: {
    updateMethod: function updateMethod() {
      ...
      this.circles.forEach(function (circle, index) {
        if (index < _this.currentActive) circle.classList.add("active");else circle.classList.remove("active");
      });
...
var __vue_render__$4 = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div class=\"progress-container\" data-v-984e2c6e><div id=\"progress\" class=\"progress\" data-v-984e2c6e></div> " + _vm._ssrList(_vm.quantity, function (index) {
    return "<div" + _vm._ssrClass("circle", {
      'active': index <= _vm.currentActive
    }) + " data-v-984e2c6e>" + _vm._ssrEscape(_vm._s(index)) + "</div>";
  }) + "</div>")]);
};
...
var __vue_scope_id__$4 = "data-v-984e2c6e";
/* module identifier */

var __vue_module_identifier__$4 = "data-v-984e2c6e";
/* functional template */
...
var script$3 = {
  ...
  methods: {
    sendSelect: function sendSelect(value) {
...
var __vue_render__$3 = function __vue_render__() {
  ...
  }, [_vm._ssrNode(_vm._ssrList(_vm.options, function (item, index) {
    return "<div class=\"radio\" data-v-553522c8><input id=\"id-radio\" name=\"radio\" type=\"radio\"" + _vm._ssrAttr("disabled", _vm.value.disabled) + _vm._ssrAttr("checked", _vm.value.value == item.value) + _vm._ssrAttr("value", _vm.value) + " data-v-553522c8> <label for=\"radio-1\" class=\"radio-label\" data-v-553522c8>" + _vm._ssrEscape(_vm._s(item.label)) + "</label></div>";
  }))]);
};
...
var __vue_scope_id__$3 = "data-v-553522c8";
/* module identifier */

var __vue_module_identifier__$3 = "data-v-553522c8";
/* functional template */
...
var script$2 = {
  ...
  methods: {
    selecionouMethod: function selecionouMethod(value, event) {
      this.closeOptionsSelect(event.target.parentElement);
      this.open = false;
      this.$emit('selectedValue', value);
    },
    onClickMethod: function onClickMethod($event) {
      this.open = !this.open;
...
var __vue_render__$2 = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div id=\"dropdown-select\" data-v-6fcee97e><span id=\"select-label\" class=\"select\" data-v-6fcee97e>" + _vm._ssrEscape(_vm._s(_vm.item.value && _vm.item.label ? _vm.item.label : 'Selecione')) + "</span> <svg id=\"svg-icon\" width=\"17\" height=\"8\" viewBox=\"0 0 17 8\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" data-v-6fcee97e><path d=\"M1.58839 4.51715e-07L0.621093 0.870535L8.51744 8L16.4138 0.870535L15.4465 9.17941e-08L8.51744 6.28571L1.58839 4.51715e-07Z\" fill=\"#FBBE2F\" data-v-6fcee97e></path></svg></div> <div id=\"dropdown-list__element_select\" data-v-6fcee97e>" + _vm._ssrList(_vm.items, function (itemMoment, index) {
    return "<div" + _vm._ssrClass("dropdown-list__item", {
      '--selected': itemMoment == _vm.item,
      '--first': index == 0,
      '--last': index == _vm.items.length - 1
    }) + " data-v-6fcee97e>" + _vm._ssrEscape(_vm._s(itemMoment.label)) + "</div>";
  }) + "</div>")]);
};
...
var __vue_scope_id__$2 = "data-v-6fcee97e";
/* module identifier */

var __vue_module_identifier__$2 = "data-v-6fcee97e";
/* functional template */
...
}, __vue_inject_styles__, __vue_script__, __vue_scope_id__, __vue_is_functional_template__, __vue_module_identifier__, false, undefined, createInjectorSSR, undefined);/* eslint-disable import/prefer-default-export */var components$1=/*#__PURE__*/Object.freeze({__proto__:null,BoxContent: __vue_component__$e,Button: __vue_component__$d,BoxButtons: __vue_component__$c,Footer: __vue_component__$b,HeaderMenu: __vue_component__$a,LinkText: __vue_component__$9,TextFormField: __vue_component__$8,InputField: __vue_component__$7,LabelField: __vue_component__$6,MsgField: __vue_component__$5,ProgressBarSteps: __vue_component__$4,Radio: __vue_component__$3,Select: __vue_component__$2,H1: __vue_component__$1,H2: __vue_component__});var install = function installShipSmartLibrary(Vue) {
...
var components=/*#__PURE__*/Object.freeze({__proto__:null,'default': install,BoxContent: __vue_component__$e,Button: __vue_component__$d,BoxButtons: __vue_component__$c,Footer: __vue_component__$b,HeaderMenu: __vue_component__$a,LinkText: __vue_component__$9,TextFormField: __vue_component__$8,InputField: __vue_component__$7,LabelField: __vue_component__$6,MsgField: __vue_component__$5,ProgressBarSteps: __vue_component__$4,Radio: __vue_component__$3,Select: __vue_component__$2,H1: __vue_component__$1,H2: __vue_component__});// only expose one global var, with component exports exposed as properties of
